...
declare type ServerActionExecute<RETURN, INPUT> = QRL<(form: FormData | INPUT | SubmitEvent) => Promise<ServerActionReturn<RETURN>>>;

declare interface ServerActionReturn<RETURN> {
 ...
 * @alpha
 */
export declare interface ServerActionUse<RETURN, INPUT> extends ServerActionReturn<RETURN> {
    readonly id: string;
