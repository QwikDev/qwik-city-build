...
var qwik_city_sw_register_build_default = '"serviceWorker"in navigator?navigator.serviceWorker.getRegistrations().then(e=>{for(const r of e){const o="__url".split("/").pop();r.active?.scriptURL.endsWith(o||"service-worker.js")&&r.unregister().catch(console.error)}}):console.log("Service worker not supported in this browser.")';
